...
class TestIntegration(unittest.TestCase):
    ...
    def test_course_search_tool_real_operations(self):
        ...
        self.assertEqual(search_tool.last_sources[0]["text"], "Real Search Test Course - Lesson 1")
    ...
    def test_tool_manager_real_integration(self):
        ...
        # Add test data
        course = Course(title="Tool Manager Test Course", instructor="Tester", lessons=[])
        chunks = [
            CourseChunk(
        ...
        # Test tool execution
        result = tool_manager.execute_tool("search_course_content", query="data structures")
    ...
    def test_rag_system_real_components_mock_ai(self, mock_anthropic_class):
        ...
        mock_response = Mock()
        mock_response.content = [Mock(text="Based on the course content, data structures are fundamental.")]
        ...
        with patch('rag_system.DocumentProcessor') as mock_doc_processor:
            ...
            rag_system.vector_store = VectorStore(self.chroma_path, "all-MiniLM-L6-v2", max_results=5)
            ...
            self.assertEqual(response, "Based on the course content, data structures are fundamental.")
            ...
            self.assertEqual(call_args.kwargs["messages"][0]["content"], "Answer this question about course materials: What is 2 + 2?")
    ...
    def test_data_persistence(self):
        ...
        course = Course(title="Persistence Test Course", instructor="Tester", lessons=[])
    ...
    def test_concurrent_operations(self):
        ...
        chunks = [
            CourseChunk(content="Content for course A", course_title="Concurrent Course A", chunk_index=0),
            CourseChunk(content="Content for course B", course_title="Concurrent Course B", chunk_index=0)
        ]
